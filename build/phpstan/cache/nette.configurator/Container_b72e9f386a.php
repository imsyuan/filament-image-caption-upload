...
class Container_b72e9f386a extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b72e9f386a $container)
			{
	...
	public function createServiceContainer(): Container_b72e9f386a
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/Users/changhsiaohsuan/workspace/filament-image-caption-upload/phpstan-baseline.neon',
			'usedLevel' => '5',
