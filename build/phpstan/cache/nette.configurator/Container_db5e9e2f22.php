...
class Container_db5e9e2f22 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_db5e9e2f22 $container)
			{
	...
	public function createServiceContainer(): Container_db5e9e2f22
	{
		return $this;
	}
